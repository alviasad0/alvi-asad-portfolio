   ...
   return (
     <section>
       <div className="flex justify-center w-full h-full overflow-hidden">
         <div className=" max-w-screen-2xl h-full mx-auto items-center gap-12">
  ...
  const scaleX = useSpring(scrollYProgress, {
    ...
    return (
      <div className="portfolio relative" ref={ref}>
        <div className="progress sticky top-0 left-0 pt-12 text-center text-orange-500 text-4xl">
